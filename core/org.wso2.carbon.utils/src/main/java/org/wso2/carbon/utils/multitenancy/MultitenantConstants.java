...
public class MultitenantConstants {
    ...
    public static final QName MULTITENANT_SERVICE_IN_OUT_OPERATION = new QName("anonInOutOp");
    public static final QName MULTITENANT_SERVICE_OUT_ONLY_OPERATION = new QName("anonOutonlyOp");
